    ...
    <Fragment>
      <div className="flex rounded border-2 p-1 border-[#1f2e4e] gap-3 mb-3">
        ...
        <div className=" flex flex-col justify-center w-[60%]">
          <h4 className="font-bold text-xs md:text-sm lg:text-xl">
            {item.attName}
          </h4>
          <div className="flex flex-col  gap-3 ">
            <div className="text-slate-400 py-2 font-bold text-xs md:text-sm lg:text-sm">
              {" "}
              {item.attCity},{" "}
              <span className="text-slate-400 font-semibold text-xs md:text-sm lg:text-sm">
                {item.attCountryCode}
              </span>
            </div>
            <div className="font-sans text-black line-clamp-2 lg:line-clamp-4 ">
              {/* Lorem ipsum dolor sit amet consectetur, adipisicing elit.
              Doloremque est impedit facere sit laboriosam temporibus inventore
              ab nobis non fugiat adipisci rerum sapiente perferendis
              laudantium, odio quasi modi placeat veniam! */}
        ...
        <div className="min-h-32 min-w-24 max-h-32 max-w-24  md:min-h-48 md:min-w-32 md:max-h-48 md:max-w-32  lg:min-h-60 lg:min-w-40 lg:max-h-60 lg:max-w-40  flex border-3 border-yellow-500 flex-col justify-between p-3 ml-auto bg-[#00646f] rounded-r-lg">
          <div className="mt-auto mb-3">
            <div className="text-right">
              <div className="lg:text-lg md:text-base text-sm font-bold text-white ">
                From
              </div>
              ...
              <div className="text-xs mb-2  lg:text-lg text-white">
                Per Adult
              </div>
